/*
 * File: _coder_stewart_platform_v2_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "stewart_platform_v2",                                /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
 ...
 * Return Type  : void
 */
void stewart_platform_v2_api(const mxArray *const prhs[6], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  final_angle = (real_T(*)[6])mxMalloc(sizeof(real_T[6]));
  ...
  dx = emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "dx");
  dy = emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "dy");
  dz = emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "dz");
  /* Invoke the target function */
  stewart_platform_v2(yaw, pitch, roll, dx, dy, dz, *final_angle);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*final_angle);
}
...
void stewart_platform_v2_atexit(void)
{
  ...
  stewart_platform_v2_xil_terminate();
  stewart_platform_v2_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_stewart_platform_v2_api.c
 *
 * [EOF]
 */
